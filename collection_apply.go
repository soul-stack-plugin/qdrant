...
func (m *QdrantModule) applyCollectionProbed(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
	f := params.GetFields()
...
// could deliver.
func (m *QdrantModule) applyCollectionPresent(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
...
func (m *QdrantModule) applyCollectionRecreated(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
...
// between them.
func (m *QdrantModule) reconcileCollection(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct, mayRecreate bool) error {
	f := params.GetFields()
	apiKey := stringOrEmpty(f["api_key"])
	name := strings.TrimSpace(stringOrEmpty(f["name"]))
...
func (m *QdrantModule) verifyCollection(ctx context.Context, stream eventStream, api qdrantAPI, declared map[string]any, name, apiKey, did, message string, output map[string]any) error {
	info, exists, err := readCollection(ctx, api, name, apiKey)
	if err != nil {
		return sendFailure(stream, err.Error())
	}
...
func (m *QdrantModule) applyCollectionAbsent(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
	f := params.GetFields()
	apiKey := stringOrEmpty(f["api_key"])
	name := strings.TrimSpace(stringOrEmpty(f["name"]))
...
func (m *QdrantModule) createCollection(ctx context.Context, api qdrantAPI, name string, body map[string]any, apiKey string) error {
...
func (m *QdrantModule) patchCollection(ctx context.Context, api qdrantAPI, name string, body map[string]any, apiKey string) error {
...
func (m *QdrantModule) dropCollection(ctx context.Context, api qdrantAPI, name string, apiKey string) error {

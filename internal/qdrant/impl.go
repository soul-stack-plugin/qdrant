...
// Module is the driver every object of this artifact delegates to — one body
...
// nowUTC is the current time, honouring the [Module.clock] injection point.
...
func (m *Module) open(ctx context.Context, cfg connConfig) (qdrantAPI, error) {
	if m.connect != nil {

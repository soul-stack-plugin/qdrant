...
// moduleWith returns a Module wired to the fake.
func moduleWith(api qdrantAPI) *Module {
	return &Module{connect: func(context.Context, connConfig) (qdrantAPI, error) { return api, nil }}
}

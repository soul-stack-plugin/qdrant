...
// hold.
func (m *Module) applyPinged(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
...
// is waiting out.
func (m *Module) applyReadyProbed(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
	apiKey := stringOrEmpty(params.GetFields()["api_key"])
...
func (m *Module) applyVersionProbed(ctx context.Context, stream eventStream, api qdrantAPI, params *structpb.Struct) error {
	apiKey := stringOrEmpty(params.GetFields()["api_key"])
